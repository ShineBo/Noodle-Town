  ...
  return (
    ...
    >
      <div className='bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:40px_40px]'>
          ...
          >
            ...
            <div >
              <p className=' text-center mt-6 font-inconsol font-bold leading-normal text-xl text-gray-100'>
                <span className='max-md:hidden '>Whether you&#39;re a fan of classic ramen, crave the bold flavors of pad Thai, <br /></span>
                <span className='max-md:hidden '>or yearn for the comfort of a steaming bowl of pho, Noodle Haven has something for everyone. <br /></span>
                <span className=''>Our menu features a fusion of traditional recipes and modern twists, ensuring a symphony of flavors with every bite.</span>
              </p>
            </div>
          </motion.div>
        <div className=' px-40 max-md:px-6'>
          <h3 className=' max-md:text-center text-4xl mt-7 max-sm:text-3xl font-inconsol text-gray-100'>Local Food</h3>
        ...
        <div className=' px-40 max-md:px-6'>
          <h3 className='max-md:text-center text-4xl mt-7 max-sm:text-3xl font-inconsol text-gray-100'>Thailand Food</h3>
          <div className="flex flex-wrap justify-between max-md:justify-center ">
        ...
        <div className=' px-40 max-md:px-6'>
          <h3 className='max-md:text-center text-4xl mt-7 max-sm:text-3xl font-inconsol text-gray-100'>Vietnamese Food</h3>
          <div className="flex flex-wrap justify-between max-md:justify-center ">
        ...
        <div className=' px-40 max-md:px-6'>
          <h3 className='max-md:text-center text-4xl mt-7 max-sm:text-3xl font-inconsol text-gray-100'>Japanese Food</h3>
          <div className="flex flex-wrap justify-between max-md:justify-center ">
        ...
        <div className=' px-40 max-md:px-6'>
          <h3 className='max-md:text-center text-4xl mt-7 max-sm:text-3xl font-inconsol text-gray-100'>Drinks</h3>
          <div className="flex flex-wrap justify-between max-md:justify-center ">
